        ...
        <div class="flex justify-between items-center mb-8">
            ...
            <div class="bg-white rounded-lg shadow-sm px-4 py-2">
                <div class="text-sm text-gray-600">
                    ...
                    Kasir: <span class="font-semibold text-gray-900"><?php echo e(auth()->user()->name); ?></span>
                </div>
            </div>
        </div>
                        ...
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                <button wire:click="sortBy('users.name')" class="flex items-center hover:text-gray-700">
                                    Kasir
                                    <!--[if BLOCK]><![endif]--><?php if($sortBy === 'users.name'): ?>
                                        <i class="fas fa-sort-<?php echo e($sortDirection === 'asc' ? 'up' : 'down'); ?> ml-1"></i>
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                </button>
                            </th>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                <button wire:click="sortBy('total')" class="flex items-center hover:text-gray-700">
                                    Total
                                    <!--[if BLOCK]><![endif]--><?php if($sortBy === 'total'): ?>
                                        <i class="fas fa-sort-<?php echo e($sortDirection === 'asc' ? 'up' : 'down'); ?> ml-1"></i>
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                </button>
                            </th>
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="hover:bg-gray-50">
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-4">
                                            <div class="text-sm font-medium text-gray-900">
                                                <?php echo e($transaction->user->name); ?></div>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <?php echo e($transaction->payment_type === 'cash'
                                        ? 'bg-green-100 text-green-800'
                                        : ($transaction->payment_type === 'card'
                                            ? 'bg-blue-100 text-blue-800'
                                            : 'bg-purple-100 text-purple-800')); ?>">
                                        <?php echo e(ucfirst($transaction->payment_type)); ?>

                                    </span>
                                    <!--[if BLOCK]><![endif]--><?php if($transaction->payment_amount > $transaction->total): ?>
                                        <div class="text-xs text-gray-500 mt-1">
                                            Kembalian: Rp
                                            <?php echo e(number_format($transaction->payment_amount - $transaction->total, 0, ',', '.')); ?>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                    <div class="flex items-center space-x-2">
                                        <span
                                            ...
                                            <?php echo e($transaction->saleItems->count()); ?>

                                            item<?php echo e($transaction->saleItems->count() > 1 ? 's' : ''); ?>

                                        </span>
                                        <button class="text-blue-600 hover:text-blue-800 text-sm font-medium"
                                            onclick="toggleDetails(<?php echo e($transaction->id); ?>)">
                            ...
                            <tr id="details-<?php echo e($transaction->id); ?>" class="hidden bg-blue-50">
                                <td colspan="6" class="px-6 py-4">
                                    <div class="bg-white rounded-lg p-4 border border-blue-200">
                                        <h4 class="font-semibold text-gray-800 mb-3 flex items-center">
                                            <i class="fas fa-list-ul mr-2 text-blue-500"></i>
                                            Detail Produk Transaksi #<?php echo e($transaction->id); ?>

                                        </h4>
                                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $transaction->saleItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="bg-gray-50 rounded-lg p-3 border border-gray-200">
                                                    <div class="flex items-start space-x-3">
                                                        <!--[if BLOCK]><![endif]--><?php if($item->product->image): ?>
                ...
                <div class="bg-white px-4 py-3 border-t border-gray-200 sm:px-6">
                    <div class="flex items-center justify-between">
                        <div class="text-sm text-gray-700">
                            ...
                            dari <?php echo e($transactions->total()); ?> hasil
                        </div>
                        <div class="flex space-x-1">
                            <!--[if BLOCK]><![endif]--><?php if($transactions->onFirstPage()): ?>
                                <span
                            ...
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $transactions->getUrlRange(1, $transactions->lastPage()); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href="<?php echo e($url); ?>"
                                    class="relative inline-flex items-center px-4 py-2 text-sm font-medium <?php echo e($transactions->currentPage() == $page ? 'text-blue-600 bg-blue-50 border-blue-500' : 'text-gray-500 bg-white border-gray-300 hover:bg-gray-50'); ?> border">
                                    <?php echo e($page); ?>

                                </a>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->

                            <!--[if BLOCK]><![endif]--><?php if($transactions->hasMorePages()): ?>
...
<?php /**PATH D:\Projek\midtrans\Pos-kasir\resources\views/livewire/transaction/index.blade.php ENDPATH**/ ?>