                                ...
                                <div class="text-center">
                                    ...
                                    <div class="flex items-center justify-center space-x-1">
                                        ...
                                        <p class="text-xs text-gray-500">Stock:
                                            <span
                                                class="<?php echo e($product->stock <= 5 ? 'text-red-500 font-semibold' : 'text-green-500'); ?>">
                ...
                <div class="bg-white rounded-xl shadow-lg p-6 border border-gray-100">
                    <h2 class="text-2xl font-semibold mb-6 text-gray-800 flex items-center">
                        ...
                        <!--[if BLOCK]><![endif]--><?php if(!empty($cart)): ?>
                            <span
                                class="ml-2 bg-green-500 text-white text-xs px-2 py-1 rounded-full"><?php echo e(count($cart)); ?></span>
                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                    </h2>
                            ...
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $cart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex items-center justify-between border-b border-gray-100 pb-4">
                                    ...
                                    <div class="flex items-center space-x-3">
                                        <button wire:click="updateQty(<?php echo e($index); ?>, <?php echo e($item['qty'] - 1); ?>)"
                                        ...
                                        <input type="number" wire:model.live="cart.<?php echo e($index); ?>.qty"
                                            wire:change="updateQty(<?php echo e($index); ?>, $event.target.value)"
                        ...
                        <div class="border-t border-gray-200 pt-4 mt-4">
                            <div class="flex justify-between items-center text-xl font-bold text-gray-900">
                                ...
                                <span class="text-blue-600">Rp
                                    <?php echo e(number_format($this->getTotal(), 0, ',', '.')); ?></span>
                            </div>
                        </div>
                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.form.input-error','data' => ['messages' => $errors->get('payment_type')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['messages' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->get('payment_type'))]); ?>
...
<?php endif; ?>
                            ...
                            <div>
                                ...
                                <?php if (isset($component)) { $__componentOriginal8d499d75702cee5e9aae94bf7f660f12 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal8d499d75702cee5e9aae94bf7f660f12 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.form.input-error','data' => ['messages' => $errors->get('payment_amount')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('form.input-error'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['messages' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->get('payment_amount'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal8d499d75702cee5e9aae94bf7f660f12)): ?>
<?php $attributes = $__attributesOriginal8d499d75702cee5e9aae94bf7f660f12; ?>
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="flex justify-between text-sm">
                                        ...
                                        <span class="font-semibold text-blue-600">Rp
                                            <?php echo e(number_format((float) $payment_amount, 0, ',', '.')); ?></span>
                                    </div>
                                    <hr class="border-gray-300">
                                    <div class="flex justify-between text-lg font-bold">
                                        <span class="text-gray-800">Kembalian:</span>
                                        <span class="text-green-600">Rp
                                            <?php echo e(number_format((float) $change_amount, 0, ',', '.')); ?></span>
                                    </div>
                                </div>
                            </div>
...
<?php /**PATH D:\Projek\midtrans\Pos-kasir\resources\views/livewire/pos/index.blade.php ENDPATH**/ ?>