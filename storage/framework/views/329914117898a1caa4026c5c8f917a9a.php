                ...
                <div class="fixed inset-y-0 left-0 w-64 bg-blue-800 text-white p-4">
                    ...
                    <nav>
                        ...
                        <a href="<?php echo e(route('settings.index')); ?>" wire:navigate
                            class="flex items-center p-3 rounded-lg mb-2 transition-all hover:bg-blue-700 cursor-pointer <?php echo e(request()->routeIs('settings.*') ? 'bg-blue-700' : ''); ?>"
                            @click="isSidebarOpen = false">
...
<?php /**PATH D:\Projek\midtrans\Pos-kasir\resources\views/components/dashboard/mobile-sidebar.blade.php ENDPATH**/ ?>