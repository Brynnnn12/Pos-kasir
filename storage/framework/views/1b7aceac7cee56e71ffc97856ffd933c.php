...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layout.auth','data' => ['title' => 'Login','subtitle' => 'Welcome back! Please sign in to your account']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Login','subtitle' => 'Welcome back! Please sign in to your account']); ?>

     <?php $__env->slot('footer', null, []); ?> 
        <p>Don't have an account?
            <a href="<?php echo e(route('register')); ?>" class="text-blue-400 hover:text-blue-300 font-medium">Sign up here</a>
        </p>
     <?php $__env->endSlot(); ?>
    ...
    <form method="POST" action="<?php echo e(route('login')); ?>" class="space-y-4" x-data="{ showPassword: false }">
        <?php echo csrf_field(); ?>
        ...
        <div>
            ...
            <input id="email" type="email" name="email" value="<?php echo e(old('email')); ?>" required autofocus
                ...
                class="w-full px-3 py-2.5 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors <?php $__errorArgs = ['email'];
        ...
        <div>
            ...
            <div class="relative">
                <input id="password" :type="showPassword ? 'text' : 'password'" name="password" required
                    ...
                    class="w-full px-3 py-2.5 pr-10 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="flex items-center justify-between text-sm">
            ...
            <?php if(Route::has('password.request')): ?>
                <a href="<?php echo e(route('password.request')); ?>" class="text-blue-600 hover:text-blue-500 font-medium">
                    Forgot password?
                </a>
            <?php endif; ?>
        </div>
...
<?php endif; ?>
<?php /**PATH D:\Projek\midtrans\Pos-kasir\resources\views/auth/login.blade.php ENDPATH**/ ?>