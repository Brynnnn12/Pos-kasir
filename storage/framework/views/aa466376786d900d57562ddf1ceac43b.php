...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.table','data' => ['headers' => ['No', 'User', 'Total', 'Payment Type', 'Payment Amount', 'Change Amount', 'Created At', 'Actions']]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['headers' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(['No', 'User', 'Total', 'Payment Type', 'Payment Amount', 'Change Amount', 'Created At', 'Actions'])]); ?>
            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $sales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($sale->payment_type); ?></td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">Rp
