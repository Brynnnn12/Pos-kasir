    ...
    <div class="flex items-center justify-between px-6 py-4">
        ...
        <div class="flex items-center space-x-4">
            ...
            <nav class="flex items-center space-x-2 text-sm">
                ...
                <span class="text-gray-900 font-medium"><?php echo e($title ?? 'Dashboard'); ?></span>
            </nav>
        </div>
            ...
            <div class="relative" x-data="{ open: false }">
                <button @click="open = !open" @click.away="open = false"
                    ...
                    <div
                        ...
                        <span class="font-bold text-white text-sm"><?php echo e(substr(Auth::user()->name, 0, 1)); ?></span>
                    </div>
                </button>
...
<?php /**PATH D:\Projek\midtrans\Pos-kasir\resources\views/components/dashboard/header.blade.php ENDPATH**/ ?>