<div>
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 flex items-center">
            ...
            <div>
                ...
                <p class="text-2xl font-semibold text-gray-800">Rp {{ number_format($todayRevenue, 0, ',', '.') }}</p>
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 flex items-center">
            ...
            <div>
                ...
                <p class="text-2xl font-semibold text-gray-800">{{ $todayCustomers }}</p>
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 flex items-center">
            ...
            <div>
                ...
                <p class="text-2xl font-semibold text-gray-800">{{ $todayProductsSold }}</p>
                            ...
                            <td class="px-4 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        ...
                                        <div class="text-sm text-gray-500">{{ $sale->payment_type }}</div>
                                    </div>
                                </div>
                            </td>
    ...
    <script>
        ...
        const categoryValues = @json($categoryData->pluck('total'));
